...
int main()
{
	...
	GLfloat vertices[] =
	{
		//Position of the image     //Normals                //Texture coords (image).
	...
	// Diffuse map
	image = stbi_load("images/57.png", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 1.0f, 0.0f, 1.0f);
